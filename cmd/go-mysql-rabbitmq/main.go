...
import (
	...
	"github.com/khlystov/go-mysql-rabbitmq/river"
)

var configFile = flag.String("config", "./etc/river.toml", "go-mysql-rabbitmq config file")
...
var data_dir = flag.String("data_dir", "", "path to save data")
